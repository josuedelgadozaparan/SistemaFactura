...
class nosotros_model{
  ...
  public function ConsultarTablaProducto(){
    ...
    try {
      ...
      $sql='SELECT IdProducto,NombreProducto,CodigoProducto,CantidadProducto,StockMinimoProducto,ValorProducto,ProveedorProducto from producto';
      $sth=$c->prepare($sql);
